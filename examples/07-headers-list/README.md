...
```bash
cargo run --bin cgo-gen -- check --config examples/07-headers-list/config.yaml
cargo run --bin cgo-gen -- generate --config examples/07-headers-list/config.yaml --dump-ir
```
