...
```bash
./examples/static-shared-library/build-libs.sh
cargo run --bin cgo-gen -- generate --config examples/static-shared-library/config.yaml --dump-ir --go-module example.com/cgo-gen/examples/static-shared-library/generated
cd examples/static-shared-library/generated && LD_LIBRARY_PATH=../lib go test ./...
```
