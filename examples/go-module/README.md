...
```bash
cargo run --bin cgo-gen -- check --config examples/go-module/config.yaml
cargo run --bin cgo-gen -- generate --config examples/go-module/config.yaml --dump-ir --go-module example.com/cgo-gen/examples/go-module/generated
```
